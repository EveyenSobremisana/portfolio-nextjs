...
export const customCursor = () => {
  var myCursor = document.querySelectorAll(".mouse-cursor"),
    ...
    portfolio_topbar = document.querySelector(".portfolio_topbar "),
    ...
    if (document.body) {
      ...
      (window.onmousemove = function (s) {
        ...
        document.body.addEventListener(
          "mouseenter",
          // "a,.portfolio_topbar .trigger, .cursor-pointer",
          function () {
            ...
            portfolio_topbar && mouseEvent(portfolio_topbar);
...
export const portfolio_my_load = () => {
  portfolio_preloader();
  setTimeout(() => {
...
export const stickyNav = () => {
  ...
  const stickys = document.querySelectorAll(".portfolio_topbar");
